DBox "Extract Transit Route System UI" title: "Extract Transit Route System"
    Button "Master Route System" 0, 0 do
        master_rts = ChooseFile({{"Route system", "*.rts"}}, "Choose Master Route System", null)
    enditem

    Edit Text "Master Route System" after, same variable: master_rts
